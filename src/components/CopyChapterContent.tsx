  ...
  return (
    ...
    >
      <button
        ...
        class="-m-2 p-2 transition-colors cursor-copy outline-none focus-visible:ring-2 ring-zinc-500 ring-offset-zinc-100 dark:ring-offset-zinc-900 ring-offset-2"
        onClick={async () => {
          try {
            const textContent = document.querySelector(
              `#${translationCode}-${contentId} .chapter-markdown-container`
            )?.textContent;
